                ...
                case 2:
                    {
                        ...
                        response.sendRedirect("indexworker.jsp");
                        break;
                    }
                default:
            
                         response.sendRedirect("index.jsp?message=Please enter the valid username and pass ");
                    //request.setAttribute(message, "error in user name or password");
                    break;       
            } 
