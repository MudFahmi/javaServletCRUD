...
public final class viewtreatment_005fadmin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                        <h1><a href=\"index.html\">Pharmacy</span> <small>For better life</small></a></h1>\n");
      out.write("                    </div>\n");
      ...
      out.write("                            <h2><span>ADD WORKER </span> </h2>\n");
      out.write("\n");
      out.write("                            <div class=\"clr\"></div>\n");
      out.write("             ");
           ...
           while(rs.next()){
                ...
                out.println("<tr>"+"<td>" +  " <input type='text' name='id' value='"+rs.getInt("id")+"'>"+"</td>"                             
                        ...
                        "<td>"+  " <input type='text' name='t_name' value='"+rs.getString("expiredate")+"'>"+"</td>"+
                                ...
                                "</td>"+"<td>"+"<a href='updatetreatment.jsp?id="+rs.getInt("id")+"'>Updatedelete</a>"+"</br>"+
                                 "  <a href='deletetreatment?id="+rs.getInt("id")+"'>Delete</a>"+
                        "</td>"+
     ...
     out.println("</table>");
      ...
      out.write("                             <h2 class=\"star\"> Admin Pannel : </h2>\n");
      out.write("                             <div class=\"clr\"></div>\n");
      out.write("\n");
      ...
      out.write("                                                                    <tbody>\n");
      out.write("                                                                        <tr><td></td>\n");
      out.write("                                                                            <td><form action=\"addperson.jsp\" ><input type=\"submit\" value=\"Add Worker \" name=\"Show_order\"  id=\"submit1\"/></form></td>\n");
      out.write("                                                                          </tr>\n");
      out.write("\n");
      out.write("                                                                        <tr><td></td>\n");
      out.write("                                                                            <td><form action=\"viewperson.jsp\" ><input type=\"submit\" value=\"View Worker \" name=\"Show_order\"  id=\"submit1\"/></form></td>\n");
      out.write("                                                                          </tr>\n");
      out.write("\n");
      out.write("                                                                         <tr><td></td>\n");
      out.write("                                                                            <td><form action=\"addtreatment_admin.jsp\" ><input type=\"submit\" value=\"Add Treatment \" name=\"Show_order\"  id=\"submit1\"/></form></td>\n");
      out.write("                                                                          </tr>\n");
      out.write("\n");
      out.write("                                                                        <tr><td></td>\n");
      out.write("                                                                            <td><form action=\"viewtreatment_admin.jsp\" ><input type=\"submit\" value=\"View Treament \" name=\"Show_order\"  id=\"submit1\"/></form></td>\n");
      out.write("                                                                          </tr>\n");
      out.write("\n");
      out.write("                                                                        \n");
      out.write("                                                                        <tr><td></td>\n");
